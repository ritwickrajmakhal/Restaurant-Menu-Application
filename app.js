...
const render = (filter = "all", searchKey = "") => {
  ...
  menuItems.innerHTML = menu
    ...
    .map((item) => {
      return `<div class="menu-item col-12 col-sm-12 col-md-6 col-lg-4">
      <div class="card mb-3">
        <img height="300" src="${item.img}" class="card-img-top" alt="${item.title}" style="object-fit:cover;">
        <div class="card-body">
